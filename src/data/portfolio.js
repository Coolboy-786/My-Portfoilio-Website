...
export const projects = [
  {
    num: '01',
    title: 'Skin Disease Classification — Deep Learning',
    desc: '3-stage ML pipeline: semantic segmentation → MobileNetV2 CNN feature extraction → ensemble evaluation across 23 skin conditions. Achieved 93.2% classification accuracy using transfer learning, stratified k-fold CV, and hyperparameter tuning — outperforming a vanilla CNN baseline by 7.4 percentage points.',
    highlight: '93.2% accuracy · 23 disease classes · 7.4pp over baseline',
  ...
  },
  {
    ...
    highlight: 'PostgreSQL · Power BI · RFM Segmentation · CLV',
  ...
  },
  {
    ...
    highlight: '10K+ records · EDA · Advanced SQL · Statistical Segmentation',
